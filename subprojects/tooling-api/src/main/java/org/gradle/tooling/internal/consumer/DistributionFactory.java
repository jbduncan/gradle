...
public class DistributionFactory {
    ...
    public DistributionFactory(Iterable<ScriptingLanguage> scriptingLanguages) {
    ...
    public Distribution getDefaultDistribution(File projectDir, boolean searchUpwards) {
        BuildLayout layout = new BuildLayoutFactory(scriptingLanguages).getLayoutFor(projectDir, searchUpwards);
