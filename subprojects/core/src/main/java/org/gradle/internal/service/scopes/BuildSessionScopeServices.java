...
public class BuildSessionScopeServices extends DefaultServiceRegistry {
    ...
    CacheLayout createCacheLayout(StartParameter startParameter, ScriptingLanguages scriptingLanguages) {
        BuildLayout buildLayout = new BuildLayoutFactory(scriptingLanguages).getLayoutFor(new BuildLayoutConfiguration(startParameter));
