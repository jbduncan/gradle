...
public class CommandLineActionFactory {
    ...
    private final Iterable<ScriptingLanguage> scriptLanguages = new DefaultScriptingLanguages();
    ...
    private static class WithLogging implements Action<ExecutionListener> {
        ...
        WithLogging(ServiceRegistry loggingServices, Iterable<ScriptingLanguage> scriptingLanguages, List<String> args, LoggingConfiguration loggingConfiguration, Action<ExecutionListener> action) {
        ...
        public void execute(ExecutionListener executionListener) {
            ...
            LayoutToPropertiesConverter layoutToPropertiesConverter = new LayoutToPropertiesConverter(scriptingLanguages);
